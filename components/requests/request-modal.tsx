...
export function RequestModal({
	...
	const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
		...
		try {
			if (activeTab === "Repair") {
				if (editingRequest) await updateRepairRequest(editingRequest.id, formData);
				else await createRepairRequest(formData);
			} else if (activeTab === "CCTV") {
				if (editingRequest) await updateCctvRequest(editingRequest.id, formData);
				else await createCctvRequest(formData);
			} else if (activeTab === "Internet") {
				if (editingRequest) await updateInternetRequest(editingRequest.id, formData);
				else await createInternetRequest(formData);
			}
			...
			<div className="bg-card text-card-foreground border border-border w-full max-w-2xl rounded-xl shadow-2xl overflow-hidden my-8">
				...
				<div className="flex items-center justify-between border-b border-border px-6 py-4">
					<div className="flex items-center gap-2">
						...
						<h3 className="font-bold text-lg">{editingRequest ? "Edit Official Request" : "Submit Official Request"}</h3>
					</div>
					<button
						onClick={onClose}
				...
				<form onSubmit={handleSubmit} className="p-6 space-y-4 text-sm">
						...
						<div className="space-y-4">
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
								<div className="space-y-1">
									...
									<input
										...
										defaultValue={editingRequest?.details?.requestingOffice || ""}
								...
								<div className="space-y-1">
									...
									<input
										required
										name="requestedBy"
										defaultValue={editingRequest?.details?.requestedBy || defaultUserName}
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
								<div className="space-y-1">
									...
									<select required name="equipmentType"
										defaultValue={editingRequest?.details?.equipmentType || ""} className={selectCls}>
								...
								<div className="space-y-1">
									...
									<select required name="natureOfRepair"
										defaultValue={editingRequest?.details?.natureOfRepair || ""} className={selectCls}>
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
								<div className="space-y-1">
									...
									<input
										required
										name="brandName"
										defaultValue={editingRequest?.details?.brandName || ""}
								...
								<div className="space-y-1">
									...
									<input
										required
										name="modelNo"
										defaultValue={editingRequest?.details?.modelNo || ""}
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
								<div className="space-y-1">
									...
									<input
										required
										name="serialNo"
										defaultValue={editingRequest?.details?.serialNo || ""}
								...
								<div className="space-y-1">
									...
									<input
										required
										name="propertyNo"
										defaultValue={editingRequest?.details?.propertyNo || ""}
							...
							<div className="space-y-1">
								...
								<select required name="actionType"
										defaultValue={editingRequest?.details?.actionType || ""} className={selectCls}>
							...
							<div className="space-y-1">
								...
								<textarea
									name="preInspection"
									defaultValue={editingRequest?.details?.preInspection || ""}
									rows={2}
						...
						<div className="space-y-4">
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
								<div className="space-y-1">
									...
									<select required name="requestType"
										defaultValue={editingRequest?.details?.requestType || ""} className={selectCls}>
								...
								<div className="space-y-1">
									...
									<input
										required
										name="location"
										defaultValue={editingRequest?.details?.location || ""}
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
								<div className="space-y-1">
									...
									<input
										...
										defaultValue={editingRequest?.details?.requestingParty || defaultUserName}
								...
								<div className="space-y-1">
									...
									<input
										required
										name="address"
										defaultValue={editingRequest?.details?.address || ""}
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
								...
								<div className="space-y-1">
									...
									<input
										...
										required
										name="dateOfFootage"
										defaultValue={editingRequest?.details?.dateOfFootage || ""}
										className={inputCls}
									/>
								</div>
							</div>
							...
							<div className="space-y-1">
								...
								<input
									required
									name="timeOfFootage"
									defaultValue={editingRequest?.details?.timeOfFootage || ""}
							...
							<div className="space-y-1">
								...
								<textarea
									required
									name="purpose"
									defaultValue={editingRequest?.details?.purpose || ""}
									rows={2}
							...
							<div className="space-y-1">
								...
								<select required name="requirements"
									defaultValue={editingRequest?.details?.requirements || ""} className={selectCls}>
					...
					<div className="pt-4 border-t border-border flex items-center justify-end gap-3">
						...
						<Button type="submit" disabled={loading} className="cursor-pointer font-bold">
							{loading ? "Saving..." : editingRequest ? "Save Changes" : `Submit ${activeTab === "Internet" ? "Installation" : activeTab} Request`}
						</Button>
					</div>
				</form>
			</div>
